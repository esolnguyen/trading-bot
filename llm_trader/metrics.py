"""Slim performance metrics for backtest output.

Ported from Vibe-Trading's backtest/metrics.py — only the calculations a
single-symbol LLM-in-the-loop backtest actually consumes (no benchmarks,
no per-symbol breakdowns, no annualisation tables).
"""
