...
from src.dashboard.config import STAT_META
from src.dashboard.formatters import fmt_stat, position_gauge
from src.dashboard.loaders import load_api_costs, load_statistics
...
def _render_stat_grid(stats: dict) -> None:
    known = {
        ...
        if k in STAT_META and k != "calculation_date"
    }
    unknown = {
        k: v for k, v in stats.items()
