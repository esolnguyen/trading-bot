...
from src.infrastructure.ai.providers.response_models import ChatResponseModel
from src.infrastructure.ai.provider_types import ProviderMetadata, InvocationResult, ProviderClients
    ...
    def _build_provider_metadata(self) -> Dict[str, ProviderMetadata]:
        ...
        return {
            'googleai': ProviderMetadata(
                ...
                config=self.settings.get_model_config(self.settings.google_studio_model),
                supports_chart=True,
            ...
            'openrouter': ProviderMetadata(
                ...
                config=self.settings.get_model_config(self.settings.openrouter_base_model),
                supports_chart=True,
                has_rate_limits=True
            ),
