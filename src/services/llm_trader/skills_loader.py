"""Load SKILL.md playbooks from src/services/llm_trader/skills/ for prompt injection.

Skills are markdown playbooks that teach the LLM domain-specific patterns:
candlestick reading, SMC, perp funding, etc. Selected skills are concatenated
