...
from src.services.analysis.indicators.support_resistance import (
    advanced_support_resistance_numba, fibonacci_bollinger_bands_numba,
    fibonacci_pivot_points_numba, fibonacci_retracement_numba,
    find_support_resistance_numba, floating_levels_numba, pivot_points_numba,
    support_resistance_numba, support_resistance_numba_advanced,
)
from src.services.analysis.indicators.trend import (
    adx_numba, ichimoku_cloud_numba, parabolic_sar_numba, pfe_numba,
    supertrend_numba, td_sequential_numba, trix_numba, vortex_indicator_numba,
)
...
class StructureMixin:
    ...
    def support_resistance(
        ...
        return self._base.calculate_indicator(
            support_resistance_numba, self.high, self.low, length,
    ...
    def find_support_resistance(
        ...
        return self._base.calculate_indicator(
            find_support_resistance_numba, self.close, support, resistance,
    ...
    def support_resistance_advanced(
        ...
        return self._base.calculate_indicator(
            ...
            self.high, self.low, self.close, self.volume, length,
            required_length=length,
        )
    ...
    def advanced_support_resistance(
        ...
        return self._base.calculate_indicator(
            ...
            length, strength_threshold, persistence, volume_factor, price_factor,
            required_length=length,
        )

    def fibonacci_retracement(self, length: int = 20) -> np.ndarray:
        return self._base.calculate_indicator(
            fibonacci_retracement_numba, length, self.high, self.low,
            required_length=length,
        )
    ...
    def fibonacci_bollinger_bands(
        ...
        return self._base.calculate_indicator(
            fibonacci_bollinger_bands_numba, hlc3, self.volume, length, mult,
            required_length=length,
        )
    ...
    def floating_levels(
        ...
        return self._base.calculate_indicator(
            ...
            length, multiplier, lookback, level_up, level_down,
    ...
    def pivot_points(self) -> Tuple[
        ...
        return self._base.calculate_indicator(
            pivot_points_numba, self.high, self.low, self.close,
            required_length=1,
        )
    ...
    def fibonacci_pivot_points(self) -> Tuple[
        ...
        return self._base.calculate_indicator(
            fibonacci_pivot_points_numba, self.high, self.low, self.close,
            required_length=1,
        )
    ...
    def adx(self, length: int = 14) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
        return self._base.calculate_indicator(
            adx_numba, self.high, self.low, self.close, length,
            required_length=length,
        )
    ...
    def supertrend(
        ...
        return self._base.calculate_indicator(
            supertrend_numba, self.high, self.low, self.close,
            length, multiplier,
        )
    ...
    def ichimoku_cloud(
        ...
        return self._base.calculate_indicator(
            ichimoku_cloud_numba, self.high, self.low,
            conversion_length, base_length, lagging_span2_length, displacement,
            required_length=max(base_length, lagging_span2_length),
        )

    def parabolic_sar(
        self, step: float = 0.02, max_step: float = 0.2
    ) -> np.ndarray:
        return self._base.calculate_indicator(
            parabolic_sar_numba, self.high, self.low, step, max_step,
        )

    def vortex_indicator(self, length: int = 14) -> Tuple[np.ndarray, np.ndarray]:
        return self._base.calculate_indicator(
            vortex_indicator_numba, self.high, self.low, self.close, length,
            required_length=length + 1,
        )

    def trix(
        self, length: int = 18, scalar: float = 100, drift: int = 1
    ) -> np.ndarray:
        return self._base.calculate_indicator(
            trix_numba, self.close, length, scalar, drift,
            required_length=length,
        )
    ...
    def td_sequential(self, length: int = 9) -> np.ndarray:
        return self._base.calculate_indicator(
            td_sequential_numba, self.close, length, required_length=5,
        )
