...
from src.domain.trading.backtest_metrics import Trade, calc_metrics
from src.domain.trading.models import Action, OpenPosition
from src.infrastructure.binance.historical_data import fetch_history
from src.infrastructure.binance.market_data import Candle, MarketDataClient
from src.services.llm_trader.llm_decision import LLMDecision, LLMDecisionEngine
...
def _build_arg_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--interval", default=None, help="Kline interval (default from config)")
