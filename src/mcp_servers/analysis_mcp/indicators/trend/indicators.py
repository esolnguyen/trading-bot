...
from src.mcp_servers.analysis_mcp.indicators.volatility import atr_numba
...
def supertrend_numba(
    ...
    for i in range(1, n):
        ...
        upperband[i], lowerband[i] = calculate_band_adjustments(
            close, upperband, lowerband, i
        )
