...
import logging
from src.legacy.domain.trading.models import TradingMemory, TradeRecord
...
class TradingMemoryService:
    ...
    def get_context_summary(self) -> str:
        ...
        full_history = [TradeRecord.from_dict(d) for d in full_history_dicts]
    ...
    def _build_memory_from_history(self) -> TradingMemory:
        ...
        for trade_data in recent_history:
            try:
                decision = TradeRecord.from_dict(trade_data)
