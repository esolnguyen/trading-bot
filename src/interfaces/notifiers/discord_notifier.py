...
from src.shared.decorators import retry_async
...
if TYPE_CHECKING:
    ...
    from src.shared.format_utils import FormatUtils
...
class DiscordNotifier(BaseNotifier):
    ...
    def __init__(self, logger: logging.Logger, config: Settings, unified_parser: "UnifiedParser", formatter: "FormatUtils", bot: Any, file_handler: DiscordFileHandler) -> None:
