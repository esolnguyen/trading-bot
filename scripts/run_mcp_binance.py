"""Launcher for the Binance feed MCP server.

Owns transport selection — the server module
(``src/mcp_servers/binance/server.py``) only builds the FastMCP instance
...
if __name__ == "__main__":
    ...
    from src.mcp_servers.binance_mcp.server import mcp  # noqa: E402
