"""Launcher for the RAG retrieval MCP server.

Owns transport selection — the server module
(``src/mcp_servers/rag/server.py``) only builds the FastMCP instance and
registers handlers.
...
if __name__ == "__main__":
    ...
    from src.mcp_servers.rag_mcp.server import mcp  # noqa: E402
